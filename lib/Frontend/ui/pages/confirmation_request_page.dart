    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('Konfirmasi Laporan', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
          centerTitle: true,
          bottom: TabBar(
...
class _ConfirmationList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = _items;
    if (items.isEmpty) {
      return Center(child: Text('Tidak ada laporan $status', style: TextStyle(color: Colors.grey.shade600)));
    }
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(item['company']!, style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: Text(item['badge']!, style: TextStyle(color: Color(int.parse(item['badgeTextColor']!)), fontWeight: FontWeight.bold, fontSize: 12)),
                  ),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 6),
                  Text(item['progress']!, style: TextStyle(color: Colors.grey.shade600, fontSize: 12)),
                ],
              ),
            ],
          ),
