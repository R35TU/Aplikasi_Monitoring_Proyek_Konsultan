...
class _DataReportDetailPageState extends State<DataReportDetailPage> {
  ...
  void _loadReports() {
    setState(() {
      _reportsFuture = _reportRepository
          .ambilLaporanBerdasarkanProyek(widget.project.id)
          .then((reports) {
            _allReports = reports;
            ...
            for (var r in reports) {
              ...
              final dateStr = dateStrRaw.length >= 10
                  ? dateStrRaw.substring(0, 10)
                  : dateStrRaw;
